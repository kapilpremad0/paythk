...
const guideSchema = new mongoose.Schema({
  name: { type: String, required: true },        // guide name
  location: {
...
guideSchema.virtual('imageUrls').get(function () {
  const baseUrl = process.env.BASE_URL || 'http://localhost:5000';
  return this.images.map(img => `${baseUrl}/uploads/${img}`);
});

guideSchema.virtual('profile_url').get(function () {
...
guideSchema.virtual("action_div").get(function () {
  return `
    <div class="dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-end">
        <a class="dropdown-item" href="/admin/guides/${this._id}">
          <i data-feather="eye" class="me-50"></i>
          <span>Show</span>
        </a>
        <a class="dropdown-item" href="/admin/guides/edit/${this._id}">
          <i data-feather="edit-2" class="me-50"></i>
          <span>Edit</span>
        </a>
        <a class="dropdown-item delete-guide" href="#" data-id="${this._id}" data-name="${this.name}">
